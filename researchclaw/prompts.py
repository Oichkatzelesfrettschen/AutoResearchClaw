...
_DEFAULT_STAGES: dict[str, dict[str, Any]] = {
    ...
    "research_decision": {
        ...
        "user": (
            ...
            "   EXCEPTION: For null-result experiments (topic contains 'null result', "
            "'upper limit', 'non-detection', 'negative result'), identical outputs "
            "across conditions IS the expected finding — the absence of differentiation "
            "confirms the null. In this case, criterion 4 is SATISFIED by showing the "
            "null is robust across algebraic frameworks/analysis methods.\n"
